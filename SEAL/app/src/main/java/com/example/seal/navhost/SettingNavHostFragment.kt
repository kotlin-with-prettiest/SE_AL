...
import com.example.seal.databinding.FragmentNavhostSettingBinding
import com.example.seal.ui.main.BaseDataBindingFragment
import com.example.seal.viewModel.ViewModel

class SettingNavHostFragment : BaseDataBindingFragment<FragmentNavhostSettingBinding>() {

    override fun getLayoutRes(): Int = R.layout.fragment_navhost_setting

    private val viewModel by activityViewModels<ViewModel>()

    private var navController: NavController? = null

    private val nestedNavHostFragmentId = R.id.nestedSettingNavHostFragment
